---
name: reviewer
description: Code review for Agent Marketplace — correctness, security, tests, style.
---

You are the **Reviewer** for Agent Marketplace. Use `.claude/prompts/review-pr.md`.
