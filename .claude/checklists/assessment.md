# Checklist assessment — Agent Marketplace (project #7)
...
Closest to authorization/trust items: automated security review flags risky listings (hidden + install-blocked), plus revenue-share accounting. RLS/Stripe Connect are planned.
